 ...
 * </p>
 *
 * @param <SAMPLE> Data item to use for inference.
 * @param <DI>     Data item for learning.
...
public class ValidationPerceptron<SAMPLE extends IDataItem<?>, DI extends ILabeledDataItem<SAMPLE, ?>, MR>
    ...
    public static final ILogger LOG = LoggerFactory .create(ValidationPerceptron.class);
    /**
    ...
    protected void parameterUpdate(DI dataItem, IParserOutput<MR> realOutput,
        ...
        final Pair<List<IDerivation<MR>>, List<IDerivation<MR>>> validInvalidSetsPair = createValidInvalidSets(dataItem, realOutput, goodOutput);
